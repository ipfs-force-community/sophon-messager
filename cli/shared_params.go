...
var setSharedParamsCmd = &cli.Command{
	Name:      "set",
	Usage:     `set current shared params commands, eg. set: venus-messager share-params set "{\"expireEpoch\": 10000, \"gasOverEstimation\": 0, \"maxFee\": 100000, \"maxFeeCap\": 20000, \"selMsgNum\": 20, \"scanInterval\": 10, \"maxEstFailNumOfMsg\": 5}"`,
	ArgsUsage: "[params]",
