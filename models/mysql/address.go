...
func (s mysqlAddressRepo) UpdateFeeParams(ctx context.Context, addr address.Address, gasOverEstimation, gasPremiumRation float64, maxFee, maxFeeCap big.Int) error {
